...
const fontSize: valueType = { title: 40, subtitle: 30, body1: 20, body2: 20 };
const lineHeight: valueType = { title: "22px", subtitle: "40.85px", body1: "22px", body2: "27.24px" };

const mfontWeight: valueType = { title: 700, subtitle: 700, body1: 400, body2: 400 };
const mfontSize: valueType = { title: 18, subtitle: 16, body1: 14, body2: 12 };
const mlineHeight: valueType = { title: "24.51px", subtitle: "21.79px", body1: "22px", body2: "16.34px" };
